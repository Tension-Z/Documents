...
{% hint style="warning" %}
SSTap 虽然宣称为游戏而生，但 rixCloud 接入点均没有为游戏加速优化，因此我们不对游戏加速性能提供任何保障。
{% endhint %}
...
首先你需要下载适用于 Hyper-V 的 LEDE 硬盘映像。目前 Koolshare 提供的是 RAW 格式的硬盘映像，因此你需要使用工具来进行转换。不过，rixCloud 提供了一些已经转换过的映像可以直接被使用。
